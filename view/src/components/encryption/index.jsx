        ...
        <div className="w-auto grid h-96 mt-16 mx-48 px-16 divide-y-2">
            <div>
                <form className="flex flex-col gap-6 justify-center mt-10 mb-10 px-16 w-full">
                    ...
                    <button
                        type="submit"
                        className="text-white bg-blue-600 hover:bg-blue-500 hover:border-blue-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Encrypt {/* ++ condition */}
                    </button>
                </form>
            </div>
            <div className="flex justify-center w-full">
                <div className="flex flex-col mt-10 mx-16 p-4 border shadow-sm rounded-lg w-full bg-gray-50">
                    <button
                        type="button"
                        className="py-2.5 w-40 self-end px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-500 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        Copy to clipboard
                    </button>
